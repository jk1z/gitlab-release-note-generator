...
exports.CHANGELOG_FORMAT = [exports.CHANGELOG_FORMAT_SLACK, exports.CHANGELOG_FORMAT_GITLAB];
...
exports.getChangelogByStartAndEndDate = async (startDate, endDate, options = {}) => {
    Logger.info(
        `Time range that we are looking at MRs and issues is between ${Moment.tz(startDate, Env.TZ)} and ${Moment.tz(
            endDate,
            Env.TZ
        )}`
    );
